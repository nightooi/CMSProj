...
public class ActiveRouteFileManager : IActiveRouteManager, IPostActivator<IActiveRouteManager>
{
    ...
    public ActiveRouteFileManager(IWebHostEnvironment env, IRouteMatcherFactory routeMatcher)
    {
        _env = env;
